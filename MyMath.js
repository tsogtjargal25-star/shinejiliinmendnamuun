...
const MyMath = (function MyMathFactory(Math) {
	...
	/**
	 * Текстийг цэгийн матриц руу хөрвүүлэх
	 * @param {string} текстийн агуулга
	 * @param {number} нягтрал Анхдагч нягт нь 3 байна
	 * @param {string} fontFamily үсгийн өгөгдмөл Жоржиа
	 * @param {string} fontSize үсгийн хэмжээ өгөгдмөл 60px
	 * @returns {Array} Цэгтэй массив
	 */
