...
const randomWords = ["ЖАРГАЛТАЙ", "ИНЭЭМСЭГЛ","😉"];
const wordDotsMap = {};
...
const helpContent = {
	shellType: {
		header: "Салютны төрөл",
		body: "Та ямар төрлийн салют буудуулахыг хүсч байвал (Санамсаргүй)-г сонгоод маш сайн туршлага аваарай!",
	},
	shellSize: {
		header: "Салютны хэмжээ",
		body: "Салют том байх тусмаа цэцэглэх хүрээ их байх тусам таны төхөөрөмж илүү их ажиллагаатай байх болно.",
	},
	quality: {
		header: "Зургийн чанар",
		body: "Хэрэв хөдөлгөөнт дүрс хэвийн ажиллахгүй бол та чанарыг бууруулж үзээрэй. Зургийн чанар өндөр байх тусам салют дэлбэрсний дараа илүү их оч гарч ирэх боловч зургийн өндөр чанар нь таны төхөөрөмжийг хоцроход хүргэж болзошгүй.",
	},
	skyLighting: {
		header: "Тэнгэрийг гэрэлтүүлэх",
		body: "Салют дэлбэрэх үед арын фон гэрэлтэнэ. Хэрэв таны дэлгэц хэт тод харагдаж байвал үүнийг 'бүдэг' эсвэл 'үгүй' болгон өөрчилж болно.",
	},
	scaleFactor: {
		header: "Хэмжээг өөрчлөх",
		body: "Салютыг ойроос эсвэл холоос харах боломжтой. Том салютын хувьд, ялангуяа гар утас болон таблет дээр бага хэмжээний хэмжээс сонгохыг зөвлөж байна.",
	},
	wordShell: {
		header: "Текстэн салют",
		body: "Идэвхжүүлсэн тохиолдолд, 'Шинэ оны мэнд', 'Санаа бүтэмжтэй байх болтугай' гэх мэт үг хэлбэртэй салют гарч ирнэ.",
	},
	autoLaunch: {
		header: "Салютыг автоматаар хөөргөх",
		body: "Идэвхжүүлсэн үед та төхөөрөмжийнхаа дэлгэцэн дээр зүгээр л сууж, салютыг харах боломжтой. Хэрэв та үүнийг унтраавал дэлгэц дээр товших замаар л салют хөөргөж болно.",
	},
	finaleMode: {
		header: "Нэгэн зэрэг олон салют хөөргөх",
		body: "Нэгэн зэрэг олон салют автоматаар хөөргөх боломжтой (гэхдээ эхлээд 'Салютыг автоматаар хөөргөх'-ийг идэвхжүүлэх шаардлагатай).",
	},
	hideControls: {
		header: "Удирдлагын товчлууруудыг нуух",
		body: "Дэлгэцийн дээд талын удирдлагын товчлууруудыг нуух. Хэрэв та дэлгэцийн агшин авах эсвэл саадгүй туршлага хүсвэл товчлууруудыг нууж болно. Нуусан ч гэсэн баруун дээд буланд тохиргоог нээх боломжтой.",
	},
	fullscreen: {
		header: "Бүтэн дэлгэц",
		body: "Бүтэн дэлгэцийн горимд шилжих.",
	},
	longExposure: {
		header: "Салютын очийг хадгалах",
		body: "Салютын үлдээсэн оч, гэрлийг хадгалах боломжтой.",
	},
};
...
function init() {
	...
	setOptionsForSelect(appNodes.quality, [
		{ label: "Бага", value: QUALITY_LOW },
		{ label: "Энгийн", value: QUALITY_NORMAL },
		{ label: "Өндөр", value: QUALITY_HIGH },
	]);

	setOptionsForSelect(appNodes.skyLighting, [
		{ label: "Үгүй", value: SKY_LIGHT_NONE },
		{ label: "Бүдэг", value: SKY_LIGHT_DIM },
		{ label: "Энгийн", value: SKY_LIGHT_NORMAL },
	]);
...
if (IS_HEADER) {
	...
	setLoadingStatus("Тэсэлгээний утсыг асааж байна");
	setTimeout(() => {
		var promises = [soundManager.preload()];

		Promise.all(promises).then(init, (reason) => {
			console.log("Нөөц файлуудыг ачаалж чадсангүй");
			init();
